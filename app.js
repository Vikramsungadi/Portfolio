...
function closeMenu(e) {
	...
	if (e.target.classList.contains("fa-xmark") || parent.classList.contains("menu__btns") || parent.classList.contains("menu__ul")) {
...
function showCategory(e) {
	...
	categories.forEach((categoryy) => {
		if (categoryy.innerText === text) {
			categoryy.style.setProperty("background-color", "var(--about-background)");
	...
	if (text === "FrontEnd" || "Backend" || "Others") {
		categorySkill.forEach((skill_list) => {
			if (skill_list.classList.contains(lowertext)) {
				skill_list.style.setProperty("background-color", "var(--about-background)");
...
function showAbout(e) {
	...
	if (text === "About") {
		aboutExplain.style.setProperty("background-color", "var(--about-background)");
		...
		interestExplain.style.setProperty("background-color", "var(--about-background)");
